...
admin.post("/", [managerAuth, validateUser], async (req, res) => {
  const company = req.user.company;

  let adminData = { ...req.body, role, company_name: company };
...
admin.put("/:id", [adminAuth, validateId, validateUser], async (req, res) => {
  let admin = await User.findOne({
    where: {
      id: req.params.id,
    },
